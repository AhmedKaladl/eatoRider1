...
import 'package:efood_multivendor_driver/view/base/custom_ink_well.dart';
...
import 'package:efood_multivendor_driver/view/screens/chat/widget/search_field.dart';
          ...
          child: Column(children: [
            ...
            Expanded(
              child: (conversation0 != null && conversation0.conversations != null)
                  ...
                  ) : Center(child: Text('no_conversation_found'.tr, style: IBMPlexSansArabicMedium)) : const Center(child: CircularProgressIndicator()),
            ) ,
          ]),
        );
      }),
