          ...
          builder: (orderController) {
            return Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              orderController.orderDetailsModel != null ? Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                Text('with'.tr , textAlign: TextAlign.center, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeDefault)),
                Text(
                  ' ${orderController.orderDetailsModel != null ? orderController.orderDetailsModel!.length.toString() : 0} ',
                  textAlign: TextAlign.center, style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
                  ),
                Text('items'.tr, textAlign: TextAlign.center, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeDefault)),
              ]) : const SizedBox(),
              ...
              orderController.orderDetailsModel != null ? ListView.builder(
                ...
                return Padding(
                  ...
                  child: Row(children: [
                    Text('${'item'.tr} ${index + 1}: ', style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
                    Flexible(child: Text(
                        '${orderController.orderDetailsModel![index].foodDetails!.name!} ( x ${orderController.orderDetailsModel![index].quantity})',
                        maxLines: 2, overflow: TextOverflow.ellipsis, style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                    ),
                  ]),
                );
              }) : const SizedBox(),
