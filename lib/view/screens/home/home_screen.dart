            ...
            return Column(children: [
              ...
              Container(
                ...
                child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Expanded(child: Text('my_ratings'.tr, style: IBMPlexSansArabicMedium.copyWith(
                      ...
                      child: Column(children: [
                        Row(children: [
                          authController.profileModel != null ? Text(
                            ...
                            style: IBMPlexSansArabicBold.copyWith(fontSize: 30, color: Colors.white),
                        ...
                        authController.profileModel != null ? Text(
                          ...
                          style: IBMPlexSansArabicRegular.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL, color: Colors.white),
