  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        value != null ? Text(
          value!, style: IBMPlexSansArabicBold.copyWith(fontSize: 40, color: Colors.white), textAlign: TextAlign.center,
        ...
        Text(
          title,
          style: IBMPlexSansArabicMedium.copyWith(fontSize: Dimensions.fontSizeExtraLarge, color: Colors.white),
